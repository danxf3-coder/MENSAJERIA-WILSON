...
const products = [
  ...
  {
    id: 50,
    name: "BILLETERAS MEDIANAS DOBLE CIERRE DAMA",
    code: "127",
    category: "dama-billeteras-medianas",
    description: "BILLETERAS MEDIANAS DOBLE CIERRE DAMA",
  ...
  {
    id: 58,
    name: "PORTACELULARES MEDIANA DAMA",
    code: "135",
    category: "dama-portacelulares",
    description: "PORTACELULARES MEDIANA DAMA",
